...
SOURCE_MANIFEST_REVISIONS = {
    ...
    "starlink-pss-multirate-rx-only-dnm-v4-source.yaml": "v4",
    ...
    "starlink-pss-multirate-rx-only-dnm-v9-source.yaml": "v9",
    "starlink-pss-multirate-rx-only-dnm-v10-source.yaml": "v10",
}
...
def prepare_candidate(
    ...
    *,
    ...
    if source_revision in {"v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10"}:
