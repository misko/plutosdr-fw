...
iio-gain-timeline-v8-rc1-source.yaml | iio-throughput-buffered-sampler-v7-rc1-source.yaml | iio-throughput-coverage-window-v6-rc1-source.yaml | \
...
iio-throughput-coverage-window-v6-rc1-source.yaml:final-release)
    ...
    ;;
iio-throughput-buffered-sampler-v7-rc1-source.yaml:candidate)
    protected_version='v0.45-plutoplus-spf-iio-throughput-buffered-sampler-v7-rc1'
    ;;
iio-gain-timeline-v8-rc1-source.yaml:candidate)
    protected_version='v0.45-plutoplus-spf-iio-gain-timeline-v8-rc1'
    ;;
iio-gain-timeline-v8-rc1-source.yaml:final-release)
    protected_version='v0.45-plutoplus-spf-iio-gain-timeline-v8'
    ;;
