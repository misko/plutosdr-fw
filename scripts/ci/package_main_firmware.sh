...
fixed-dwell-v057-source.yaml | adaptive-runtime-rates-v056-source.yaml | adaptive-runtime-rates-source.yaml | \
...
if [[ "$(basename "$MANIFEST")" == adaptive-scan-v1-source.yaml ||
      "$(basename "$MANIFEST")" == counter-utc-v1-source.yaml ]]; then
    adaptive_dtbs=()
...
if [[ "$(basename "$MANIFEST")" == fixed-dwell-v057-source.yaml ||
      ...
      "$(basename "$MANIFEST")" == counter-utc-v054-source.yaml ]]; then
    adaptive_dtbs=()
    for fdt_index in 0 1 2; do
        packed_dtb="$ARTIFACT_ROOT/packed-fdt-${fdt_index}.dtb"
        dumpimage -T flat_dt -p "$fdt_index" -o "$packed_dtb" "$dfu"
    ...
    scripts/issue108/check_dual_rx_topology.sh "${adaptive_dtbs[@]}"
fi
...
ddr-burst-v2-rc3-source.yaml:candidate)
    ...
    ;;
ddr-capacity-test-rc1-source.yaml:candidate)
    protected_version='v0.42-plutoplus-spf-ddr-capacity-test-rc1'
    ;;
...
ddr-ring-v1-rc2-source.yaml:final-release)
    ...
    ;;
ddr-ring-prefill-v1-rc1-source.yaml:candidate)
    protected_version='v0.44-plutoplus-spf-ddr-ring-prefill-v1-rc1'
    ;;
...
iq-direct-async-ring-v1-rc1-source.yaml:final-release)
    ...
    ;;
iq-direct-async-v2-source.yaml:final-release)
    protected_version='v0.47-plutoplus-spf-iq-direct-async-v2'
    ;;
...
adaptive-scan-v1-source.yaml:*)
    protected_version='v0.52-plutoplus-spf-adaptive-scan-v1'
    ;;
counter-utc-v054-source.yaml:candidate)
    protected_version='v0.54-plutoplus-spf-counter-utc-v1-rc1'
    ;;
adaptive-runtime-rates-source.yaml:final-release)
    protected_version='v0.55-plutoplus-spf-adaptive-runtime-rates'
    ;;
counter-utc-v1-source.yaml:candidate)
    protected_version='v0.52-plutoplus-spf-counter-utc-v1-rc1'
    ;;
adaptive-runtime-rates-v056-source.yaml:final-release)
    protected_version='v0.56-plutoplus-spf-adaptive-runtime-rates'
    ;;
fixed-dwell-v057-source.yaml:final-release)
    protected_version='v0.57-plutoplus-spf-fixed-dwell'
    ;;
adaptive-scan-v2-source.yaml:candidate)
    protected_version='v0.53-plutoplus-spf-adaptive-scan-v2-rc1'
    ;;
adaptive-scan-v2-source.yaml:final-release)
    protected_version='v0.53-plutoplus-spf-adaptive-scan-v2'
    ;;
iq-direct-async-v5-source.yaml:*)
    protected_version='v0.51-plutoplus-spf-iq-direct-async-v5'
    ;;
...
iio-throughput-hold-v1-rc1-source.yaml:candidate)
    ...
    ;;
iio-throughput-hold-v2-rc1-source.yaml:candidate)
    protected_version='v0.45-plutoplus-spf-iio-throughput-hold-v2-rc1'
    ;;
iio-throughput-timing-v1-rc1-source.yaml:candidate)
    protected_version='v0.45-plutoplus-spf-iio-throughput-timing-v1-rc1'
    ;;
iio-throughput-affinity-v1-rc1-source.yaml:candidate)
    protected_version='v0.45-plutoplus-spf-iio-throughput-affinity-v1-rc1'
    ;;
iio-throughput-rw-affinity-v2-rc1-source.yaml:candidate)
    protected_version='v0.45-plutoplus-spf-iio-throughput-rw-affinity-v2-rc1'
    ;;
iio-throughput-sampler-poll-v3-rc1-source.yaml:candidate)
    protected_version='v0.45-plutoplus-spf-iio-throughput-sampler-poll-v3-rc1'
    ;;
iio-throughput-refill-sampler-v4-rc1-source.yaml:candidate)
    protected_version='v0.45-plutoplus-spf-iio-throughput-refill-sampler-v4-rc1'
    ;;
iio-throughput-sampler-wake-v5-rc1-source.yaml:candidate)
    protected_version='v0.45-plutoplus-spf-iio-throughput-sampler-wake-v5-rc1'
    ;;
