...
# Counter UTC retains the proven adaptive scan RX0/TX2 topology.
if [[ "$manifest_name" == adaptive-scan-v1-source.yaml ||
      "$manifest_name" == counter-utc-v1-source.yaml ]]; then
