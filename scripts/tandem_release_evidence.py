...
CANDIDATE_FIRMWARE_VERSION = "v0.41-plutoplus-spf-tandem-agc-v8-rc17"
FINAL_FIRMWARE_VERSION = "v0.41-plutoplus-spf-tandem-agc-v8"
CANDIDATE_SOURCE_LOCK_REF = "refs/tags/tandem-agc-v8-rc17-source/firmware-v1"
    ...
    *,
    ...
    if stage == "candidate-pre-hardware":
        if firmware_version != CANDIDATE_FIRMWARE_VERSION:
            _fail("candidate pre-hardware firmware identity is not exact RC17")
        basename = "tandem-agc-v8-rc17-source.yaml"
