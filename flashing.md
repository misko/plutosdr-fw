...
Buildroot source tags are published. It does not yet have a version-stamped
qualified image, release checksums, or GitHub release. Do not substitute the
...
This section remains a stop condition until release notes name the exact RC1
image SHA-256 and record the version-stamped image's hardware qualification.
Once those exist, use the ordinary checksum-verified RAM-boot procedure below.
