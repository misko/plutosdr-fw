...
Raw warnings remain preserved: long IP name, missing precompiled-library path,
forward-declared identifiers, and simulator declaration/observer-port warnings.
The log has no ERROR/FATAL/CRITICAL WARNING terminal. This is not a warning-free
tool run and none of these messages is being converted into a physical waiver.
