...
VERSION = "v0.41-plutoplus-spf-tandem-agc-v8-rc17"
INDEX_SHA = "a" * 64
DFU_SHA = "b" * 64
FIT_SHA = "c" * 64
INDEX_BYTES = 9_890
...
def _candidate() -> dict[str, Any]:
    return {
        ...
        "artifact_index": {
            "path": "/private/rc17/candidate-index.json",
            "bytes": INDEX_BYTES,
            "sha256": INDEX_SHA,
        },
        "dfu": {
            "path": "/private/rc17/artifact/firmware.dfu",
            "bytes": 8_388_624,
            "sha256": DFU_SHA,
        },
...
def _operation(candidate: object, inventory: object) -> dict[str, Any]:
    return {
        ...
        "candidate_plan": _identity(
            f"/private/rc17/hardware/deploy/{SERIAL}/release-candidate-plan.json",
            candidate,
        ),
        "usb_inventory": _identity(
            f"/private/rc17/hardware/deploy/{SERIAL}/usb-inventory.json", inventory
        ),
        "target": _target(),
        "expected_current_firmware": "v0.41-plutoplus-spf-tandem-agc-v8-rc12",
        "ssh_host": "192.168.2.1",
        "receipt_path": f"/private/rc17/hardware/deploy/{SERIAL}/ram-boot-receipt.json",
...
def _receipt(candidate: object, operation: object) -> dict[str, Any]:
    return {
        ...
        "operation_plan": _identity(
            f"/private/rc17/hardware/deploy/{SERIAL}/operation-plan.json", operation
        ),
        "candidate_plan": _identity(
            f"/private/rc17/hardware/deploy/{SERIAL}/release-candidate-plan.json",
            candidate,
