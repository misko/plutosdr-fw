...
def test_rc13_docs_preserve_exact_rc12_build_and_ram_incident() -> None:
    ...
    assert "The active candidate is RC18" in releasing
    ...
    assert "The active candidate is RC18" in plan
    assert "refs/tags/tandem-agc-v8-rc18-source/firmware-v1" in releasing
    assert "refs/tags/tandem-agc-v8-rc18-source/firmware-v1" in notes
    assert "refs/tags/tandem-agc-v8-rc18-source/firmware-v1" in plan
