...
def _records() -> list[dict[str, object]]:
    ...
    targets = (2 * m2.TILE_SAMPLES, 5 * m2.TILE_SAMPLES, 8 * m2.TILE_SAMPLES)
        ...
        cases.append(
            {
                ...
                "injection_start_index": target - delta,
...
def test_three_exact_maps_qualify_requested_phases() -> None:
...
@pytest.mark.parametrize(
    ...
    [
        ("mismatch", "exact-map"),
        ("wrong-peak", "exact-map"),
        ("generation-gap", "contiguous"),
        ("false-live-claim", "exact-map"),
