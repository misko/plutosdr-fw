...
def test_iio_gain_timeline_v8_has_candidate_and_main_routes() -> None:
    ...
    for source in (builder, package, checker):
        assert manifest_name in source
    assert "release_state: candidate" in manifest
    assert "libiio_0_25_source: b48b25542681e3796ce61358237bb6ecbada5152" in manifest
    assert "metadata_source: bbbf2f13e1a5aa7edab541e76f08afb384230d77" in manifest
    assert "submodule_buildroot: 7113006f918005dfb00219788568ec0e15e69037" in manifest
    ...
    utils_main = "297dc63a066121cedf52f28ac16607ad7fdf1698"
    ...
    assert "refs/tags/iio-gain-timeline-v8-rc1-source/fw-v9" in evidence
