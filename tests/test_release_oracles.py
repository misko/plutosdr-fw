...
def test_rc3_advances_dependencies_and_rc4_reuses_them_for_top_rtl_fix() -> None:
    ...
    assert rc3 == rc4 == rc5 == rc6 == rc7 == rc8 == rc9 == rc10 == final
    for values in (rc3, rc4, rc5, rc6, rc7, rc8, rc9, rc10, final):
    ...
    for values in (rc3, rc4, rc5, rc6, rc7, rc8, rc9, rc10, final, tandem_v2):
