...
def test_runtime_unchanged_and_publication_order(tmp_path):
    ...
    # The current top's single authorization delta has its own full inverse.
    reference=(BASE/'starlink_pss_fft_staged_output_impl.v').read_bytes()
    assert hashlib.sha256(reference).hexdigest()=='b3511a70b97b91e3e9b4106ea0c9bab8df4f7a43a07ff30a5447cd522dc5d143'
