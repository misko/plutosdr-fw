...
def test_rc31_owner_route_maps_branch_manifest_package_and_version() -> None:
    ...
    assert "Require the exact protected RC31 candidate identity" in workflow
...
def test_rc31_docs_preserve_truthful_rc30_result_and_active_identity() -> None:
...
def test_rc31_evidence_identity_and_attestation_policy_are_exact() -> None:
