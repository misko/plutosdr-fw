...
def test_rc28_docs_preserve_truthful_rc27_result_and_active_identity() -> None:
    notes = NOTES.read_text(encoding="utf-8")
    assert "33067056765" in notes
    assert "1.55-GHz cooldown-0" in notes
    assert "17 explicit DECREASE" in notes
...
def test_rc28_evidence_identity_and_attestation_policy_are_exact() -> None:
