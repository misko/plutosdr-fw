...
def test_rc18_owner_route_maps_branch_manifest_package_and_version() -> None:
    ...
    assert "Require the exact protected RC18 candidate identity" in workflow
...
def test_rc18_evidence_identity_and_docs_are_active() -> None:
...
def test_rc18_keeps_single_owner_optional_github_attestation_policy() -> None:
    workflow = WORKFLOW.read_text(encoding="utf-8")
