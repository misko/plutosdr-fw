...
#define SDR_USB_GADGET_COMMAND_GET_TIME_ANCHOR (0x16)
...
#define SPF_GADGET_START_V3_MAGIC UINT32_C(0x33534753) /* "SGS3" */
#define SPF_GADGET_PROTOCOL_V1 UINT16_C(1)
#define SPF_GADGET_PROTOCOL_V2 UINT16_C(2)
#define SPF_GADGET_PROTOCOL_V3 UINT16_C(3)
...
#define SPF_GADGET_CAP_TIME_ANCHOR (UINT32_C(1) << 4)
