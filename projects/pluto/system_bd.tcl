...
# Factory-programmed FPGA Device DNA, exposed through a read-only AXI GPIO.
# Software consumes this only through the passive direct-USB identity request.
create_bd_cell -type module -reference spf_device_dna spf_device_dna_0
ad_ip_instance axi_gpio spf_device_dna_gpio
ad_ip_parameter spf_device_dna_gpio CONFIG.C_IS_DUAL 1
ad_ip_parameter spf_device_dna_gpio CONFIG.C_ALL_INPUTS 1
ad_ip_parameter spf_device_dna_gpio CONFIG.C_ALL_INPUTS_2 1
ad_ip_parameter spf_device_dna_gpio CONFIG.C_GPIO_WIDTH 32
ad_ip_parameter spf_device_dna_gpio CONFIG.C_GPIO2_WIDTH 32
...
ad_connect  sys_cpu_clk spf_device_dna_0/clk
ad_connect  sys_cpu_resetn spf_device_dna_0/resetn
ad_connect  spf_device_dna_0/dna_low spf_device_dna_gpio/gpio_io_i
ad_connect  spf_device_dna_0/dna_high spf_device_dna_gpio/gpio2_io_i
...
ad_cpu_interconnect 0x41200000 spf_device_dna_gpio
