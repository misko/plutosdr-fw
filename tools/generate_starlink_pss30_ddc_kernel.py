#!/usr/bin/env python3
"""Generate the immutable 18-bit XFFT kernel for the 30->15 MS/s DDC."""
...
def generate(output_directory: Path) -> dict[str, object]:
    ...
    with TemporaryDirectory(prefix="starlink-pss30-ddc-kernel-") as temporary:
    ...
    memory_path = output_directory / "upper_edge_pss30_x2_ddc_kernel_q17.mem"
    ...
    (output_directory / "upper_edge_pss30_x2_ddc_kernel_q17.json").write_text(
        json.dumps(evidence, indent=2, sort_keys=True) + "\n",
        encoding="utf-8",
    )
    print(
        "STARLINK_PSS30_DDC_KERNEL_PASS "
