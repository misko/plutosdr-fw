...
def run(route,output):
    ...
    tcl=Path(__file__).with_name('probe_retry_admission_endpoints_v2.tcl')
    ...
    try:
        ...
        measured={}
        for label in ['guard_reasons', 'admission_snapshot_valid', 'admission_snapshot_good_d', 'admission_snapshot_good_ce', 'guard_active', 'admission_consumed', 'fast_fault']:
