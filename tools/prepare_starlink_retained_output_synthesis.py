#!/usr/bin/env python3
"""Small source-specific copier; existing frozen v5 CLI remains the authority."""
import argparse
import hashlib
import json
import os
...
ASSETS = {
    'synthesize_retained_output.tcl': BASE+'retained_output_actual/synthesize_retained_output.tcl',
...
def prepare(qualified, actual, output):
    ...
    cli=qualified/'source_snapshot/tools/prepare_starlink_retained_output_actual.py'
