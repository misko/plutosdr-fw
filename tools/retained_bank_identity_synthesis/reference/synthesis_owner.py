...
qualified_sha='b5d112562b7db31164dc4a6ff92404de8e7d7d5d96b1c1b23e1a7dbac9d2c368'
...
assert gate['runner_sha']==sha(prepared/'synthesize_retained_summary.tcl')
assert gate['copier_sha']==sha(prepared/'prepare.py')
actual=root.parent/'retained-summary-actual-parent.XYAbt6Np'
...
cmd=['/opt/Xilinx/Vivado/2022.2/bin/vivado','-mode','batch','-notrace',
     ...
     '-source',str(prepared/'synthesize_retained_summary.tcl'),'-tclargs',expected,str(output)]
