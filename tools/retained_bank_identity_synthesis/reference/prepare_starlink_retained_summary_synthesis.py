...
ASSETS = {
    ...
    'clocks.xdc': 'tools/retained_summary_synthesis/clocks.xdc',
    'threads.tcl': 'tools/retained_summary_synthesis/threads.tcl',
    'prepare.py': 'tools/prepare_starlink_retained_summary_synthesis.py',
