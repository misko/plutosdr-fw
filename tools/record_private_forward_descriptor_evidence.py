...
from route_private_forward_descriptor import evidence
...
def record(root):
    ...
    total=tests(root/'regression-v1.xml',1753)
    tests(root/'component-v1.xml',27)
    ...
    for pattern in ['tools/*private_forward_descriptor*','tests/test_starlink_private_forward_descriptor*.py','docs/starlink-private-forward-descriptor-*.md']:
    ...
    return write_verified_archive(root/'20260911-private-forward-descriptor-evidence.tgz',sources)
