...
from route_registered_abort import evidence
...
def record(root):
    ...
    total=tests(root/'regression-v1.xml',1226)+tests(root/'route-tests-v1.xml',15)
    ...
    for pattern in ['tools/*registered_abort*.py','tests/test_starlink_registered_abort*.py','docs/starlink-registered-private-abort-*.md']:
    ...
    return write_verified_archive(root/'20260911-registered-private-abort-evidence.tgz',sources)
