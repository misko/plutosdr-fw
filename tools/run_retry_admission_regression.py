...
def run(baseline,output):
    ...
    receipt['passed']=receipt['returncode']==0 and receipt['tests']==2296 and receipt['sources_unchanged'] and not any(list(result.iter(x)) for x in ['failure','error','skipped'])
