...
from route_output_identity import evidence
...
def record(root):
    ...
    total=tests(root/'regression-v1.xml',1171)+tests(root/'evidence-tests-v1.xml',29)
    ...
    for pattern in ['tools/*output_identity*.py','tests/test_starlink_output_identity*.py','docs/starlink-output-identity-*.md']:
    ...
    return write_verified_archive(root/'20260911-output-identity-stage-evidence.tgz',sources)
