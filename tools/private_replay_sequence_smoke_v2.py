...
import shutil
import private_replay_sequence_experiment_v2 as experiment
...
def prepare(path):
    ...
    bench=bench.replace('    run_buffered_auxiliary;','    auxiliary_active=1;run_private_replay_sequence_boundaries;',1)
