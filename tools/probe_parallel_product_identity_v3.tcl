...
set paths [get_timing_paths -through $selector_drivers -to $destinations -delay_type max -max_paths 1]
...
close $f
report_timing -through $selector_drivers -to $destinations -delay_type max -max_paths 20 -file [file join $output selector_paths.rpt]
close_design
