...
gate_path = Path(__file__).resolve().parent/'retained_bank_identity_synthesis/admission.py'
gate_spec = importlib.util.spec_from_file_location('bank_identity_synthesis_admission', gate_path)
...
ASSETS = {
    'synthesize_retained_bank_identity.tcl': 'tools/retained_bank_identity_synthesis/synthesize_retained_bank_identity.tcl',
    'clocks.xdc': 'tools/retained_bank_identity_synthesis/clocks.xdc',
    'threads.tcl': 'tools/retained_bank_identity_synthesis/threads.tcl',
    'prepare.py': 'tools/prepare_starlink_retained_bank_identity_synthesis.py',
    'offline_tests.py': 'tests/test_starlink_retained_bank_identity_synthesis.py',
    'admission.py': 'tools/retained_bank_identity_synthesis/admission.py',
    'source_pins.json': 'tools/retained_bank_identity_synthesis/source_pins.json',
    ...
    'route_retained_output.tcl': 'tools/retained_bank_identity_synthesis/route_retained_output.tcl',
}
...
def prepare(qualified, actual, output):
    ...
    cli=qualified/'source_snapshot/tools/prepare_starlink_retained_bank_identity_actual.py'
