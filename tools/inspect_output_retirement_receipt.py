...
def run(route,output):
    ...
    tcl=Path(__file__).with_name('probe_output_retirement_receipt.tcl')
    ...
    try:
        ...
        measured={}
        for label in ['descriptor_ce','descriptor_data','occupancy','identity','output_occupancy','output_publication']:
