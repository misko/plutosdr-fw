...
foreach {label pattern} {
  ...
  if {$label ni {descriptor_ce descriptor_data output_publication product_publication kernel_next_ce kernel_index kernel_history} && [llength $pins] != 1} {error "ambiguous $label endpoint"}
...
puts PRIVATE_REPLAY_ENDPOINTS_OBSERVED_NOT_FULL_SIGNOFF
