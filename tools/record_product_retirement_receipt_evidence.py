...
from route_product_retirement_receipt import evidence
...
def record(root):
    ...
    total=tests(root/'regression-v1.xml',1646)
    tests(root/'component-v1.xml',26)
    ...
    for folder in ['actual-v1','aux-actual-v1','synthesis-v1','route-v1','endpoints-v1']:
        base=root/folder
    ...
    for folder in ['regression-v1','component-v1']:
    ...
    for pattern in ['tools/*product_retirement_receipt*','tests/test_starlink_product_retirement_receipt*.py','docs/starlink-product-retirement-receipt-*.md']:
    ...
    return write_verified_archive(root/'20260911-product-retirement-receipt-evidence.tgz',sources)
