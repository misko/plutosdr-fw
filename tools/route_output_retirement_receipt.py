...
def evidence(actual,synthesis,aux):
    ...
    require(len(names)==39 and (prepared/'profile.tcl').read_bytes()==(aux_prepared/'profile.tcl').read_bytes(),'exact runtime profiles')
