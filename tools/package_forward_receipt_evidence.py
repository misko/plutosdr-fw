...
from staged_fft_experiment import ROOT, audit_forwardreceipt, audit_productstage, require, sha, verify
...
def package(artifacts,output,campaign='forwardreceipt'):
    ...
    require(campaign in {'forwardreceipt','productstage'},'explicit supported campaign')
    product=campaign=='productstage';version=2 if product else 1
    ...
    add('current/docs/experiment.md',ROOT/'docs'/('starlink-product-identity-integrated-20260911.md' if product else
    ...
    require(parent_receipt['sha256']==('bad3215fc8a636d16a242111151f4f53f415f20d14733b081e261c36134bffcd' if product else
...
if __name__=='__main__':
    ...
    parser.add_argument('--campaign',choices=['forwardreceipt','productstage'],default='forwardreceipt')
