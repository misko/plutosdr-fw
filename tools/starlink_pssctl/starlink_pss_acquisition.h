...
#define PSS_MAP_VERSION_1_2 UINT32_C(0x00010002)
#define PSS_MAP_VERSION_1_3 UINT32_C(0x00010003)
#define PSS_MAP_VERSION_1_4 UINT32_C(0x00010004)
...
#define PSS_MAP_CAPABILITIES_1_2 UINT32_C(0x0000007f)
#define PSS_MAP_CAPABILITIES_1_3 UINT32_C(0x0000007f)
#define PSS_MAP_CAPABILITIES_1_4 UINT32_C(0x000000ff)
...
enum pss_map_register {
	...
	PSS_MAP_REG_INPUT_RATE_MSPS = 0xb0,
	PSS_MAP_REG_DDC_CONFIG = 0xb4,
	PSS_MAP_REG_DDC_GROUP_DELAY = 0xb8,
	PSS_MAP_REG_COEFFICIENT_ENERGY = 0xbc,
	PSS_MAP_REG_DDC_CONTRACT_0 = 0xc0,
	PSS_MAP_REG_DDC_CONTRACT_1 = 0xc4,
	PSS_MAP_REG_DDC_CONTRACT_2 = 0xc8,
	PSS_MAP_REG_DDC_CONTRACT_3 = 0xcc,
	PSS_MAP_REG_DDC_CONTRACT_4 = 0xd0,
	PSS_MAP_REG_DDC_CONTRACT_5 = 0xd4,
	PSS_MAP_REG_DDC_CONTRACT_6 = 0xd8,
	PSS_MAP_REG_DDC_CONTRACT_7 = 0xdc,
	PSS_MAP_REG_DDC_ACCEPTED = 0xe0,
	PSS_MAP_REG_DDC_EMITTED = 0xe4,
	PSS_MAP_REG_DDC_DISCONTINUITY = 0xe8,
	PSS_MAP_REG_DDC_SATURATION = 0xec,
	PSS_MAP_REG_DDC_ACCEPTED_HI = 0xf0,
	PSS_MAP_REG_DDC_EMITTED_HI = 0xf4,
};
...
enum pss_map_health_bit {
	...
	PSS_MAP_HEALTH_DDC_SATURATION = 1U << 13,
};

#define PSS_MAP_HEALTH_KNOWN_MASK_1_1 UINT32_C(0x00001fff)
#define PSS_MAP_HEALTH_KNOWN_MASK_DDC UINT32_C(0x00003fff)
#define PSS_MAP_HEALTH_CONTINUITY_MASK_1_1 UINT32_C(0x000017ff)
#define PSS_MAP_HEALTH_CONTINUITY_MASK_DDC UINT32_C(0x000037ff)
...
struct pss_map_info {
	...
	uint32_t status;
	uint32_t input_rate_msps;
	uint32_t ddc_config;
	uint32_t ddc_group_delay;
	uint32_t coefficient_energy;
	uint32_t ddc_contract[8];
};
