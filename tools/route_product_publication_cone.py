...
import product_publication_cone_experiment as publication
...
def evidence(actual,synthesis,aux):
    ...
    require(len(names)==40 and (prepared/'profile.tcl').read_bytes()==(aux_prepared/'profile.tcl').read_bytes(),'exact runtime profiles')
