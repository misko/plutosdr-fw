#!/usr/bin/env python3
"""Destination copier; bound to the independently accepted actual run."""
import argparse
import hashlib
import json
import os
...
gate_path = Path(__file__).resolve().parent/'retained_destination_synthesis/admission.py'
...
ASSETS = {
    'synthesize_retained_destination.tcl': 'tools/retained_destination_synthesis/synthesize_retained_destination.tcl',
    'clocks.xdc': 'tools/retained_destination_synthesis/clocks.xdc',
    'threads.tcl': 'tools/retained_destination_synthesis/threads.tcl',
    'prepare.py': 'tools/prepare_starlink_retained_destination_synthesis.py',
    'offline_tests.py': 'tests/test_starlink_retained_destination_synthesis.py',
    'admission.py': 'tools/retained_destination_synthesis/admission.py',
    'source_pins.json': 'tools/retained_destination_synthesis/source_pins.json',
    'derive.py': 'tools/retained_destination_synthesis/derive.py',
    'recipes.json': 'tools/retained_destination_synthesis/recipes.json',
    'route_retained_output.tcl': 'tools/retained_destination_synthesis/route_retained_output.tcl',
}
...
def prepare(qualified, actual, output):
    ...
    cli=qualified/'source_snapshot/tools/prepare_starlink_retained_destination_actual.py'
