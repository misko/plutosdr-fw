...
ROOTS = {
    'owner_failed': RECOVERY/'retained-closed-input-tests-v1.Qiqlxp0W',
    'owner39': RECOVERY/'retained-closed-input-tests-v2.gu0WbmpG',
    'parent39': RECOVERY/'retained-closed-parent.X69SNqBk',
    'parent_algebra': RECOVERY/'closed-algebra-parent.ycBAqmQD',
}


def main():
    output=RECOVERY/'retained-closed-input-package-v1'
    ...
    pins=json.loads((ROOTS['parent39']/'source-pins.json').read_text())
    ...
    output.mkdir();archive=output/'retained-closed-input-v1.tar.gz'
