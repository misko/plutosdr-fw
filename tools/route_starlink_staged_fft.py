...
def run(actual,synthesis,output):
    ...
    audited=audit_privateack_sim(actual) if 'privateack' in a['audit'] else (audit_heldhandoff_sim(actual) if 'heldhandoff' in a['audit'] else (audit_heldmeta_sim(actual) if 'heldmeta' in a['audit'] else (audit_guardfacts_sim(actual) if 'guardfacts' in a['audit'] else (
