...
from staged_fft_experiment import ROOT, audit_sim, audit_handover_sim, audit_admission_sim, audit_completion_sim, audit_replay_sim, audit_writer_sim, audit_capture_sim, audit_ordinal_sim, fresh, require, sha, verify
...
def run(actual,synthesis,output):
    ...
    audited=audit_ordinal_sim(actual) if 'ordinal' in a['audit'] else (
