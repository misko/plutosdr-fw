...
from staged_fft_experiment import ROOT, audit_sim, audit_handover_sim, audit_admission_sim, fresh, require, sha, verify
...
def run(actual,synthesis,output):
    ...
    audited=audit_admission_sim(actual) if 'admission' in a['audit'] else (
