...
from staged_fft_experiment import ROOT, audit_sim, audit_handover_sim, audit_admission_sim, audit_completion_sim, audit_replay_sim, audit_writer_sim, audit_capture_sim, audit_finalcapture_sim, audit_sequence_sim, audit_certification_sim, fresh, require, sha, verify
...
def run(actual,synthesis,output):
    ...
    audited=audit_certification_sim(actual) if 'certification' in a['audit'] else (
