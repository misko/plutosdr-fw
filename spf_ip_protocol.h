...
#define SPF_IP_CONTROL_FLAG_QUERY_TRANSPORT_CAPABILITIES (UINT32_C(1) << 3)
#define SPF_IP_CONTROL_FLAG_BUFFERED_FINITE_RX (UINT32_C(1) << 4)
#define SPF_IP_CONTROL_FLAG_USB_CLASS_PACING (UINT32_C(1) << 5)
