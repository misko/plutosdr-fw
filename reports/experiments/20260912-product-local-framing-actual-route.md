...
[Archive](20260912-product-local-framing-evidence.tgz):
**11,569,562 bytes / 811 members**, SHA256
c636012caf89b873cfa52d92f82b2a8155fb08bf7cee167d173d7f17fe821adf.
The [verification receipt](20260912-product-local-framing-evidence.json)
confirms sequential payload hashes, inventory, gzip CRC, stable archive identity
and unchanged source files. Includes prepared source inventories, actual FFT
streams/wrappers, failed and passing campaigns, routed checkpoint/reports and
focused test artifacts. Generated historical regression payloads remain local.
