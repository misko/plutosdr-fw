# Private replay verified; kernel history closes, full timing still fails
...
## Published checkpoint and evidence

Branch `codex/starlink-rx-only-do-not-merge-private-replay-sequence`:

- Source FW `e20341e6865b3f28c8d9ec9c9ebd7e58e9f3accb`.
- Route-report FW `f877cb40922403dbea8bafdfaef734c3688a0f5b`.
- HDL `e6f7bdfaf02efdd38b7ae8e5a3c83b5bd961802b`.

[Verified archive](20260912-private-replay-sequence-evidence.tgz):
**12,457,811 bytes / 1,030 members**, SHA256
`2bf94016e7740c2513deda01b6361e5994779558f3fa9771f74805656b69575b`.
[Sequential verification receipt](20260912-private-replay-sequence-evidence.json)
attests exact payload hashes/sizes, inventory, gzip CRC, stable archive identity
and unchanged source files. Prepared source inventories, actual FFT streams and
wrappers, failed harness runs, passing campaigns, synthesis/routed checkpoints,
physical observations and test XML are retained. Historical generated regression
payloads remain local; focused component artifacts are included.

The primary receiver HDL gitlink remains
`0b4bf2f0fd8c58c79852266b07f9e95770f75f36`.
No radio, PPU or main branch was modified. This is not a deployed receiver.
