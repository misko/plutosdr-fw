...
LUTAR-1 or RAMB asynchronous-control warning. Its 2.5 MS/s full audit passes
at +0.033/+0.011 ns, including Gray-bus skew. The main experimental HDL checkout
has advanced through 82173e4d to a9a4ca9a, which changes only receiver candidate
grouping. All five a9a4ca9a reports retain the clean reset/RAM warning classes;
2.5/5/10/25 pass setup/hold, while 60 misses setup by 0.056 ns on an unrelated
acquisition-memory read path. CDC-11 and inherited ADI handshake warnings remain
